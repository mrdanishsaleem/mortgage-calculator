    ...
    <form class="inputF">
      <table id="selections">
        ...
        <tr>
          ...
          <td>
            <img src="<?php echo URL; ?>/css/images/information.png" class="tTip" id="info1" title="The total purchase price of the home you wish to buy." />
          </td>
          <td class="entry">
        ...
        <tr>
          ...
          <td>
            <img src="<?php echo URL; ?>/css/images/information.png" class="tTip" id="info2" title="The expected percent interest rate you will get on your mortgage." />
          </td>
          <td class="entry">
        ...
        <tr>
          ...
          <td>
            <img src="<?php echo URL; ?>/css/images/information.png" class="tTip" id="info3" title="The percent down payment you wish to put towards the home." />
          </td>
          <td class="entry">
        ...
        <tr>
          ...
          <td>
            <img src="<?php echo URL; ?>/css/images/information.png" class="tTip" id="info4" title="The number of years it will take to repay the loan amount (30 years is normal)." />
          </td>
          <td class="entry">
